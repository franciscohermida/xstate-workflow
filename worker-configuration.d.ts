/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a08c1b7ef37726de999036b002871a12)
// Runtime types generated with workerd@1.20250712.0 2025-07-15 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
  interface Env {
    MODE: string;
    DO: DurableObjectNamespace<import("./server/index").XstateWorkflowDO>;
    QUEUE: Queue;
    WORKFLOW: Workflow;
  }
}
